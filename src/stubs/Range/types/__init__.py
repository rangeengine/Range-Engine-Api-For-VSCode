...
class CValue(PyObjectPlus):
	...
	class range.CValue(PyObjectPlus)
...
class CListValue(CPropValue):
	...
	class range.CListValue(CPropValue)
...
class SCA_IObject(CValue):
	...
	class range.SCA_IObject(CValue)
...
class KX_GameObject(SCA_IObject):
	...
	class range.KX_GameObject(SCA_IObject)
...
class SCA_ILogicBrick(CValue):
	...
	class range.SCA_ILogicBrick(CValue)
...
class SCA_ISensor(SCA_ILogicBrick):
	...
	class range.SCA_ISensor(SCA_ILogicBrick)
...
class SCA_IActuator(SCA_ILogicBrick):
	...
	class range.SCA_IActuator(SCA_ILogicBrick)
...
class SCA_IController(SCA_ILogicBrick):
	...
	class range.SCA_IController(SCA_ILogicBrick)
...
class SCA_2DFilterActuator(SCA_IActuator):
	...
	class range.SCA_2DFilterActuator(SCA_IActuator)
...
class SCA_ANDController(SCA_IController):
	...
	class range.SCA_ANDController(SCA_IController)
...
class SCA_ActuatorSensor(SCA_ISensor):
	...
	class range.SCA_ActuatorSensor(SCA_ISensor)
...
class SCA_AlwaysSensor(SCA_ISensor):
	...
	class range.SCA_AlwaysSensor(SCA_ISensor)
...
class SCA_DelaySensor(SCA_ISensor):
	...
	class range.SCA_DelaySensor(SCA_ISensor)
...
class SCA_JoystickSensor(SCA_ISensor):
	...
	class range.SCA_JoystickSensor(SCA_ISensor)
...
class SCA_KeyboardSensor(SCA_ISensor):
	...
	class range.SCA_KeyboardSensor(SCA_ISensor)

	A keyboard sensor detects player key presses.

	See module range.events for keycode values."""
...
class SCA_MouseSensor(SCA_ISensor):
	...
	class range.SCA_MouseSensor(SCA_ISensor)
...
class SCA_NANDController(SCA_IController):
	...
	class range.SCA_NANDController(SCA_IController)
...
class SCA_NORController(SCA_IController):
	...
	class range.SCA_NORController(SCA_IController)
...
class SCA_ORController(SCA_IController):
	...
	class range.SCA_ORController(SCA_IController)
...
class SCA_PropertyActuator(SCA_IActuator):
	...
	class range.SCA_PropertyActuator(SCA_IActuator)
...
class SCA_PropertySensor(SCA_ISensor):
	...
	class range.SCA_PropertySensor(SCA_ISensor)
...
class SCA_PythonController(SCA_IController):
	...
	class range.SCA_PythonController(SCA_IController)
...
class SCA_PythonJoystick(PyObjectPlus):
	...
	class range.SCA_PythonJoystick(PyObjectPlus)
...
class SCA_PythonKeyboard(PyObjectPlus):
	...
	class range.SCA_PythonKeyboard(PyObjectPlus)
...
class SCA_PythonMouse(PyObjectPlus):
	...
	class range.SCA_PythonMouse(PyObjectPlus)
...
class SCA_RandomActuator(SCA_IActuator):
	...
	class range.SCA_RandomActuator(SCA_IActuator)
...
class SCA_RandomSensor(SCA_ISensor):
	...
	class range.SCA_RandomSensor(SCA_ISensor)
...
class SCA_XNORController(SCA_IController):
	...
	class range.SCA_XNORController(SCA_IController)
...
class SCA_XORController(SCA_IController):
	...
	class range.SCA_XORController(SCA_IController)
...
class BL_ActionActuator(SCA_IActuator):
	...
	class range.BL_ActionActuator(SCA_IActuator)
...
class BL_ArmatureActuator(SCA_IActuator):
	...
	class range.BL_ArmatureActuator(SCA_IActuator)
...
class BL_ArmatureBone(PyObjectPlus):
	...
	class range.BL_ArmatureBone(PyObjectPlus)
...
class BL_ArmatureChannel(PyObjectPlus):
	...
	class range.BL_ArmatureChannel(PyObjectPlus)
...
class BL_ArmatureConstraint(PyObjectPlus):
	...
	class range.BL_ArmatureConstraint(PyObjectPlus)
...
class BL_ArmatureObject(KX_GameObject):
	...
	class range.BL_ArmatureObject(KX_GameObject)
...
class BL_Shader(PyObjectPlus):
	...
	class range.BL_Shader(PyObjectPlus)
...
class BL_ShapeActionActuator(SCA_IActuator):
	...
	class range.BL_ShapeActionActuator(SCA_IActuator)
...
class KX_TouchSensor(SCA_ISensor):
	...
	class range.KX_TouchSensor(SCA_ISensor)
...
class KX_ArmatureSensor(SCA_ISensor):
	...
	class range.KX_ArmatureSensor(SCA_ISensor)
...
class KX_BlenderMaterial(PyObjectPlus):
	...
	class range.KX_BlenderMaterial(PyObjectPlus)
...
class KX_Camera(KX_GameObject):
	...
	class range.KX_Camera(KX_GameObject)
	...
	def setViewport(self, left, bottom, right, top):
		...
		Use range.render.getWindowHeight and range.render.getWindowWidth to calculate values relative to the entire display.
...
class KX_CameraActuator(SCA_IActuator):
	...
	class range.KX_CameraActuator(SCA_IActuator)
...
class KX_CharacterWrapper(PyObjectPlus):
	...
	class range.KX_CharacterWrapper(PyObjectPlus)
...
class KX_ConstraintActuator(SCA_IActuator):
	...
	class range.KX_ConstraintActuator(SCA_IActuator)
...
class KX_ConstraintWrapper(PyObjectPlus):
	...
	class range.KX_ConstraintWrapper(PyObjectPlus)
...
class KX_FontObject(KX_GameObject):
	...
	class range.KX_FontObject(KX_GameObject)
	...
	exit_key = range.events.EventToString(range.logic.getExitKey())
...
class KX_GameActuator(SCA_IActuator):
	...
	class range.KX_GameActuator(SCA_IActuator)
...
class KX_IpoActuator(SCA_IActuator):
	...
	class range.KX_IpoActuator(SCA_IActuator)
...
class KX_LibLoadStatus(PyObjectPlus):
	...
	class range.KX_LibLoadStatus(PyObjectPlus)
	...
	range.logic.LibLoad('myblend.blend', 'Scene', async=True).onFinish = finished_cb"""
...
class KX_LightObject(KX_GameObject):
	...
	class range.KX_LightObject(KX_GameObject)
...
class KX_MeshProxy(SCA_IObject):
	...
	class range.KX_MeshProxy(SCA_IObject)
...
class KX_MouseActuator(SCA_IActuator):
	...
	class range.KX_MouseActuator(SCA_IActuator)
...
class KX_MouseFocusSensor(SCA_MouseSensor):
	...
	class range.KX_MouseFocusSensor(SCA_MouseSensor)
...
class KX_NavMeshObject(KX_GameObject):
	...
	class range.KX_NavMeshObject(KX_GameObject)
...
class KX_NearSensor(KX_TouchSensor):
	...
	class range.KX_NearSensor(KX_TouchSensor)
...
class KX_NetworkMessageActuator(SCA_IActuator):
	...
	class range.KX_NetworkMessageActuator(SCA_IActuator)
...
class KX_NetworkMessageSensor(SCA_ISensor):
	...
	class range.KX_NetworkMessageSensor(SCA_ISensor)
...
class KX_ObjectActuator(SCA_IActuator):
	...
	class range.KX_ObjectActuator(SCA_IActuator)
...
class KX_ParentActuator(SCA_IActuator):
	...
	class range.KX_ParentActuator(SCA_IActuator)
...
class KX_PolyProxy(SCA_IObject):
	...
	class range.KX_PolyProxy(SCA_IObject)
...
class KX_RadarSensor(KX_NearSensor):
	...
	class range.KX_RadarSensor(KX_NearSensor)
...
class KX_RaySensor(SCA_ISensor):
	...
	class range.KX_RaySensor(SCA_ISensor)
...
class KX_SCA_AddObjectActuator(SCA_IActuator):
	...
	class range.KX_SCA_AddObjectActuator(SCA_IActuator)
...
class KX_SCA_DynamicActuator(SCA_IActuator):
	...
	class range.KX_SCA_DynamicActuator(SCA_IActuator)
...
class KX_SCA_EndObjectActuator(SCA_IActuator):
	...
	class range.KX_SCA_EndObjectActuator(SCA_IActuator)
...
class KX_SCA_ReplaceMeshActuator(SCA_IActuator):
	...
	class range.KX_SCA_ReplaceMeshActuator(SCA_IActuator)
...
class KX_Scene(PyObjectPlus):
	...
	class range.KX_Scene(PyObjectPlus)
...
class KX_SceneActuator(SCA_IActuator):
	...
	class range.KX_SceneActuator(SCA_IActuator)
...
class KX_SoundActuator(SCA_IActuator):
	...
	class range.KX_SoundActuator(SCA_IActuator)
...
class KX_StateActuator(SCA_IActuator):
	...
	class range.KX_StateActuator(SCA_IActuator)
...
class KX_SteeringActuator(SCA_IActuator):
	...
	class range.KX_SteeringActuator(SCA_IActuator)
...
class KX_TrackToActuator(SCA_IActuator):
	...
	class range.KX_TrackToActuator(SCA_IActuator)
...
class KX_VehicleWrapper(PyObjectPlus):
	...
	class range.KX_VehicleWrapper(PyObjectPlus)
...
class KX_VertexProxy(SCA_IObject):
	...
	class range.KX_VertexProxy(SCA_IObject)
...
class KX_VisibilityActuator(SCA_IActuator):
	...
	class range.KX_VisibilityActuator(SCA_IActuator)
...
class KX_WorldInfo(PyObjectPlus):
	...
	class range.KX_WorldInfo(PyObjectPlus)
...
class KX_PythonComponent(CValue):
	...
	Since the components are loaded for the first time outside the range, then range is a fake module that contains only the class KX_PythonComponent to avoid importing all the range modules. This behavior is safer but creates some issues at loading when the user want to use functions or attributes from the range modules other than the KX_PythonComponent class. The way is to not call these functions at loading outside the range. To detect it, the range module contains the attribute __component__ when it’s imported outside the range.
